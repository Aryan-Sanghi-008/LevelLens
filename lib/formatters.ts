...
export function getLevelColor(level: NormalizedLevel): string {
  const colorMap: Record<NormalizedLevel, string> = {
    ...
    [NormalizedLevel.SENIOR]: "bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300",
    [NormalizedLevel.STAFF]: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
    [NormalizedLevel.PRINCIPAL]: "bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300",
    [NormalizedLevel.DIRECTOR]: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-900/50 dark:text-fuchsia-300",
